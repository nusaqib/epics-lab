# -----------------------------------------------------------------------
# ioc-vacuum — vacuum system simulation IOC
# -----------------------------------------------------------------------
...
dbLoadRecords("/config/db/vacuum.db", "P=${IOC_PREFIX}")
...
set_pass0_restoreFile("vacuum_settings.sav")
set_pass1_restoreFile("vacuum_settings.sav")
...
create_monitor_set("vacuum_settings.req", 30, "P=${IOC_PREFIX}")
